from src.utils.gapphelper import GappHelper
import time
...
class Actions:
    def __init__(self, slackhelper, user_info=None):
        self.gapphelper = GappHelper()
        self.sheet = self.gapphelper.open_sheet()
    ...
    def help(self):
        ...
        """
        return {
            'text': 'Available Commands: \n `/steel my-task e.g. /steel my-task` \n To get task assigned to you.\n'
                    ' \n `/steel show-task [date]{dth-month-year} e.g. /steel show-task 5th-june-2018` \n Show all tasks for a particular date \n'
                    '\n `/steel show-task [today] e.g. /steel show-task today` \n Show all tasks for today \n'
                    '\n `/steel show-task [tomorrow] e.g. /steel show-task tomorrow` \n Show all tasks for tomorrow \n'}
